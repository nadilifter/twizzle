...
interface ImageUploadProps {
  ...
  type: "logo" | "favicon" | "hero" | "program" | "product" | "team";
  required?: boolean;
}
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            Recommended: {type === "favicon" ? "32x32px" : type === "logo" ? "Transparent PNG" : type === "program" ? "Landscape, 800×450px" : type === "product" ? "Square, 800×800px" : type === "team" ? "Portrait, 600×800px" : "1920x1080px"}
          </p>
        </div>
      </div>
    </div>
