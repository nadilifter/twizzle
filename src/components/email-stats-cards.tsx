    ...
    <div className="grid gap-4 px-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 lg:px-6 *:data-[slot=card]:shadow-xs *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card">
      <Card>
        <CardHeader className="relative">
          ...
          <CardTitle className="text-3xl font-semibold tabular-nums">15,240</CardTitle>
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardTitle className="text-3xl font-semibold tabular-nums">42.8%</CardTitle>
          <div className="absolute right-4 top-4">
            <Badge variant="outline" className="flex gap-1 rounded-lg text-xs">
              <TrendingUpIcon className="size-3" />
              +1.2%
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">Unique opens</div>
        </CardFooter>
      </Card>
      <Card>
        <CardHeader className="relative">
          <CardDescription>Click Rate</CardDescription>
          <CardTitle className="text-3xl font-semibold tabular-nums">3.2%</CardTitle>
          <div className="absolute right-4 top-4">
            <Badge variant="outline" className="flex gap-1 rounded-lg text-xs">
      ...
      <Card>
        <CardHeader className="relative">
          ...
          <CardTitle className="text-3xl font-semibold tabular-nums">0.8%</CardTitle>
          <div className="absolute right-4 top-4">
            <Badge
              variant="outline"
              className="flex gap-1 rounded-lg text-xs text-green-600 border-green-600"
            >
              Healthy
            </Badge>
          </div>
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">Reputation strong</div>
