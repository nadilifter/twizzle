      ...
      <Card className="relative overflow-hidden w-full max-w-[400px]">
        ...
        <CardContent className="grid gap-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button type="button" variant="outline" className="w-full flex-col gap-1.5 h-auto py-3" onClick={handleMicrosoftSignIn} disabled={isLoading || !microsoftCsrfToken}>
            ...
            <Button type="button" variant="outline" className="w-full flex-col gap-1.5 h-auto py-3" onClick={handleGoogleSignIn} disabled={isLoading || !googleCsrfToken}>
