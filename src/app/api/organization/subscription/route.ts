...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (validatedData.billingCycle && validatedData.billingCycle !== currentSubscription.billingCycle) {
    ...
    const subscription = await db.organizationSubscription.update({
      ...
      data: {
        ...
        currentPeriodStart: validatedData.billingCycle !== currentSubscription.billingCycle ? now : currentSubscription.currentPeriodStart,
