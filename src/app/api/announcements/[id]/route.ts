  ...
  try {
    ...
    const announcement = await db.announcement.update({
      ...
      data: {
        ...
        ...(validatedData.targetProgramId !== undefined && { targetProgramId: validatedData.targetProgramId }),
        ...(validatedData.targetEventId !== undefined && { targetEventId: validatedData.targetEventId }),
