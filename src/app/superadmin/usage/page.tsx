...
export default async function UsagePage() {
  ...
  const utilizationPct =
    data.activePoolSize > 0 ? Math.round((data.peakUsage / data.activePoolSize) * 100) : 0;
  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      <div>
        ...
        <p className="text-muted-foreground">Monitor SMS pool capacity and system utilization</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">max orgs texting one guardian</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">of {data.totalPoolSize} in pool</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">peak / verified capacity</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">phone-org-number pairings</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-900 dark:bg-amber-950">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
              ...
              orgs will force number reuse, breaking inbound routing for that guardian. Consider
              purchasing additional toll-free numbers.
            </p>
          </div>
        </div>
      )}
      ...
      {data.topPhones.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Guardian phone numbers with the most org assignments — these are closest to exhausting
              pool capacity
            </CardDescription>
          </CardHeader>
          <CardContent>
