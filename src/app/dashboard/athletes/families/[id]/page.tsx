// @deprecated - Legacy Family detail page. Use /dashboard/athletes/guardians instead.
"use client"
...
export default function FamilyDetailPage() {
  ...
  const familyId = typeof params.id === "string" ? params.id : null
  ...
  if (error || !family) {
    return (
      <div className="flex flex-col items-center justify-center h-[50vh] gap-4">
        <h1 className="text-2xl font-bold">{error || "Family Not Found"}</h1>
        <Button asChild>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{family.address || "No address provided"}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
               <div>
                  ...
                  <p className={`text-2xl font-bold ${Number(family.balance) > 0 ? "text-destructive" : "text-green-600"}`}>
               ...
               <div className="pt-2 border-t">
                 ...
                 {family.paymentMethods && family.paymentMethods.length > 0 ? (
           ...
           <Tabs defaultValue="members" className="w-full">
            ...
            <TabsContent value="members" className="mt-6 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {family.athletes && family.athletes.map(athlete => (
               ...
               <Card>
                 ...
                 <CardContent>
                   <Table>
                     ...
                     <TableBody>
                       {family.invoices && family.invoices.map(inv => (
                         <TableRow key={inv.id}>
                       ...
                       {(!family.invoices || family.invoices.length === 0) && (
                         <TableRow>
