      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatCurrency(data.kpis.revenueThisMonth)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatCurrency(data.kpis.recurringRevenue)}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {data.kpis.paidInvoices.toLocaleString()} of {data.kpis.totalInvoices.toLocaleString()} invoices paid
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-1 pb-0">
              {paymentChartData.length > 0 ? (
                <ChartContainer config={paymentMethodConfig} className="mx-auto aspect-square max-h-[250px]">
                  <PieChart>
        ...
        <Card>
          ...
          <CardContent>
            {invoiceChartData.length > 0 ? (
              <ChartContainer config={invoiceStatusConfig} className="aspect-auto h-[250px] w-full">
