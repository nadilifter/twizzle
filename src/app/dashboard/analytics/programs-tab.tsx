...
import { BookOpen, UserPlus, BarChart3, Clock, DollarSign } from "lucide-react";
import {
  Area,
  AreaChart,
  Bar,
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {data.kpis.activeEnrollments.toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">Athletes currently enrolled</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Across programs with capacity</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Athletes waiting for a spot</p>
              </CardContent>
            </Card>
          </div>
        )
              ...
              {filteredTrend.length > 0 ? (
                <ChartContainer config={trendConfig} className="aspect-auto h-[250px] w-full">
                  <AreaChart data={filteredTrend}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent labelFormatter={formatMonth} />} />
                    <Area
                      dataKey="count"
                      type="monotone"
