...
import { Pie, PieChart, Bar, BarChart, CartesianGrid, XAxis, YAxis, Area, AreaChart, Label } from "recharts"
            ...
            {loading ? (
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data.kpis.totalAthletes.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data.kpis.activePrograms.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data.kpis.totalEnrollments.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{data.kpis.teamMembers.toLocaleString()}</div>
              ...
              <Card>
                ...
                <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
                  {filteredTrend.length > 0 ? (
                    <ChartContainer config={enrollmentConfig} className="aspect-auto h-[250px] w-full">
                      <AreaChart data={filteredTrend}>
                        ...
                        <ChartTooltip
                          cursor={false}
                          content={<ChartTooltipContent labelFormatter={formatMonth} indicator="dot" />}
                        />
                        <Area
                          dataKey="count"
                          type="natural"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Distribution of active athletes across levels</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {levelChartData.length > 0 ? (
                      ...
                      >
                        ...
                        >
                          ...
                          <ChartTooltip cursor={false} content={<ChartTooltipContent hideLabel />} />
                          <Bar dataKey="count" layout="vertical" radius={5} fill="hsl(var(--chart-1))" />
                        </BarChart>
                      </ChartContainer>
                    ) : (
                      <div className="flex items-center justify-center h-[250px] text-muted-foreground text-sm">
