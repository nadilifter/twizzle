          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {data.kpis.activeAthletes.toLocaleString()} of{" "}
                  {data.kpis.totalAthletes.toLocaleString()} all-time athletes still active
                </p>
              </CardContent>
            </Card>
            <Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {data.kpis.newThisMonth} new &minus; {data.kpis.churnedThisMonth} churned this
                  month
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Athletes with payment failures</p>
                  </div>
