...
export function GLCodeAssignments() {
  ...
  const codesWithAssignments = glCodes.filter(
    (c) =>
      ...
      c._count.programs +
        c._count.events +
        c._count.competitions +
        c._count.products +
        c._count.membershipGroups +
        c._count.passes >
        0
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Programs, events, competitions, products, memberships, and passes assigned to each GL
          code. Assign entities from their individual configuration pages.
        </CardDescription>
      </CardHeader>
      <CardContent>
