...
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  VOLUNTEER: [PERMISSIONS.DASHBOARD_VIEW, PERMISSIONS.ATHLETES_VIEW, PERMISSIONS.EVENTS_VIEW],
  ACCOUNTANT: [
    PERMISSIONS.DASHBOARD_VIEW,
...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        id: PERMISSIONS.ATHLETES_VIEW,
        label: "View Athletes",
        description: "View athlete profiles and data",
      },
      {
        id: PERMISSIONS.ATHLETES_CREATE,
        label: "Create Athletes",
        description: "Add new athletes",
      },
      {
        id: PERMISSIONS.ATHLETES_EDIT,
        label: "Edit Athletes",
        description: "Modify athlete information",
      },
      {
        id: PERMISSIONS.ATHLETES_DELETE,
        label: "Delete Athletes",
        description: "Remove athletes from the system",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: PERMISSIONS.FAMILIES_VIEW,
        label: "View Families",
        description: "View family profiles",
      },
      {
        id: PERMISSIONS.FAMILIES_CREATE,
        label: "Create Families",
        description: "Add new families",
      },
      {
        id: PERMISSIONS.FAMILIES_EDIT,
        label: "Edit Families",
        description: "Modify family information",
      },
      {
        id: PERMISSIONS.FAMILIES_DELETE,
        label: "Delete Families",
        description: "Remove families from the system",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: PERMISSIONS.TRAINING_VIEW,
        label: "View Training",
        description: "View lesson plans and programs",
      },
      {
        id: PERMISSIONS.TRAINING_CREATE,
        label: "Create Training",
        description: "Create lesson plans and programs",
      },
      {
        id: PERMISSIONS.TRAINING_EDIT,
        label: "Edit Training",
        description: "Modify training content",
      },
      {
        id: PERMISSIONS.TRAINING_DELETE,
        label: "Delete Training",
        description: "Remove training content",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: PERMISSIONS.EVENTS_VIEW,
        label: "View Events",
        description: "View events and calendar",
      },
      ...
      {
        id: PERMISSIONS.EVENTS_DELETE,
        label: "Delete Events",
        description: "Cancel or remove events",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: PERMISSIONS.COACHING_PORTAL,
        label: "Access Coach Portal",
        description: "View the coaching portal",
      },
      {
        id: PERMISSIONS.COACHING_ASSIGN,
        label: "Coach Assignment",
        description: "Be assignable as a coach for classes and programs",
      },
      {
        id: PERMISSIONS.COACHING_ATTENDANCE,
        label: "Manage Attendance",
        description: "Take and view attendance records",
      },
      {
        id: PERMISSIONS.COACHING_EVALUATIONS,
        label: "Manage Evaluations",
        description: "Fill out and view evaluations",
      },
    ],
  },
  {
