...
export const visitorKeys = {
   ...
   */
  daily: (organizationId: string, date: string) => 
    `visitors:${organizationId}:${date}`,
   ...
   */
  desktop: (organizationId: string, date: string) => 
    `visitors:${organizationId}:${date}:desktop`,
  
  /**
   * Get the Redis key for mobile visitors on a specific day
   */
  mobile: (organizationId: string, date: string) => 
    `visitors:${organizationId}:${date}:mobile`,
