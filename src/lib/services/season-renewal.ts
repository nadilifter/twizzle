    ...
    for (const instance of group.instances) {
      ...
      await tx.membershipInstance.create({
        data: {
          ...
          startDate: newStartDate,
          endDate: newEndDate,
          purchaseStartDate: instance.purchaseStartDate
            ? advanceDateOneYear(instance.purchaseStartDate)
            : null,
          purchaseEndDate: instance.purchaseEndDate
            ? advanceDateOneYear(instance.purchaseEndDate)
            : null,
          registrationStartDate: newStartDate,
          registrationEndDate: newEndDate,
          registrationStartTime: null,
...
export async function rolloverSingleSeason(
  ...
  const newSeason = await db.$transaction(
    async (tx) => {
