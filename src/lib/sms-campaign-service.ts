...
export function renderSmsCampaignPreview(body: string): string {
  const exampleContext: Record<string, string> = {
    ...
    programName: "Competitive Team Training",
    programDescription: "Competitive training for advanced skaters",
    organizationName: "Sunrise Skating",
    organizationEmail: "info@sunrise-skating.com",
