...
async function main() {
  ...
  await Promise.all([
    ...
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-3` }, update: {}, create: { id: `${ORG1_ID}-ath-3`, firstName: "Olivia", lastName: "Baker", name: "Olivia Baker", level: "Level 4", group: "JO Team", status: "ACTIVE", birthDate: new Date("2013-11-08"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-003" } }),
    ...
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-6` }, update: {}, create: { id: `${ORG1_ID}-ath-6`, firstName: "Grace", lastName: "Davis", name: "Grace Davis", level: "Level 5", group: "JO Team", status: "ACTIVE", birthDate: new Date("2011-05-20"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-006" } }),
