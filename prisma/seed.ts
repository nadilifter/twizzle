...
async function main() {
  ...
  console.log("\n🏃 Creating athletes...");
  await Promise.all([
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-1` }, update: {}, create: { id: `${ORG1_ID}-ath-1`, firstName: "Emily", lastName: "Anderson", name: "Emily Anderson", email: "emily.a@email.com", level: "Bronze", group: "Rec Bronze", status: "ACTIVE", birthDate: new Date("2016-03-15"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-001", medicalDetails: { allergies: ["peanuts"], conditions: [], emergencyContact: { name: "Michelle Anderson", phone: "(555) 101-1001" } } } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-2` }, update: {}, create: { id: `${ORG1_ID}-ath-2`, firstName: "Sophie", lastName: "Anderson", name: "Sophie Anderson", email: "sophie.a@email.com", level: "Silver", group: "Rec Silver", status: "ACTIVE", birthDate: new Date("2014-07-22"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-002" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-3` }, update: {}, create: { id: `${ORG1_ID}-ath-3`, firstName: "Olivia", lastName: "Baker", name: "Olivia Baker", level: "Competitive", group: "JO Team", status: "ACTIVE", birthDate: new Date("2013-11-08"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-003" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-4` }, update: {}, create: { id: `${ORG1_ID}-ath-4`, firstName: "Lily", lastName: "Chen", name: "Lily Chen", level: "Bronze", group: "Rec Bronze", status: "ACTIVE", birthDate: new Date("2017-01-30"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-004" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-5` }, update: {}, create: { id: `${ORG1_ID}-ath-5`, firstName: "Mia", lastName: "Chen", name: "Mia Chen", level: "Gold", group: "Rec Gold", status: "ACTIVE", birthDate: new Date("2012-09-14"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-005" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-6` }, update: {}, create: { id: `${ORG1_ID}-ath-6`, firstName: "Grace", lastName: "Davis", name: "Grace Davis", level: "Competitive", group: "JO Team", status: "ACTIVE", birthDate: new Date("2011-05-20"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-006" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-7` }, update: {}, create: { id: `${ORG1_ID}-ath-7`, firstName: "Ava", lastName: "Evans", name: "Ava Evans", level: "Silver", group: "Rec Silver", status: "TRIAL", birthDate: new Date("2015-12-03"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-007" } }),
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-8` }, update: {}, create: { id: `${ORG1_ID}-ath-8`, firstName: "Hannah", lastName: "Evans", name: "Hannah Evans", level: "Preschool", group: "Tiny Tumblers", status: "ACTIVE", birthDate: new Date("2019-08-11"), gender: "FEMALE", organizationId: ORG1_ID, customId: "SGA-008" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-1` }, update: {}, create: { id: `${ORG2_ID}-ath-1`, firstName: "Jake", lastName: "Foster", name: "Jake Foster", email: "jake.f@email.com", level: "Beginner", group: "Youth Soccer", status: "ACTIVE", birthDate: new Date("2014-04-18"), gender: "MALE", organizationId: ORG2_ID, customId: "MSC-001" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-2` }, update: {}, create: { id: `${ORG2_ID}-ath-2`, firstName: "Ethan", lastName: "Foster", name: "Ethan Foster", level: "Intermediate", group: "Teen Basketball", status: "ACTIVE", birthDate: new Date("2010-10-25"), gender: "MALE", organizationId: ORG2_ID, customId: "MSC-002" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-3` }, update: {}, create: { id: `${ORG2_ID}-ath-3`, firstName: "Sofia", lastName: "Garcia", name: "Sofia Garcia", level: "Beginner", group: "Kids Fitness", status: "ACTIVE", birthDate: new Date("2016-06-12"), gender: "FEMALE", organizationId: ORG2_ID, customId: "MSC-003" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-4` }, update: {}, create: { id: `${ORG2_ID}-ath-4`, firstName: "Lucas", lastName: "Garcia", name: "Lucas Garcia", level: "Advanced", group: "Swim Team", status: "ACTIVE", birthDate: new Date("2011-02-28"), gender: "MALE", organizationId: ORG2_ID, customId: "MSC-004" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-5` }, update: {}, create: { id: `${ORG2_ID}-ath-5`, firstName: "Chloe", lastName: "Harris", name: "Chloe Harris", level: "Beginner", group: "Youth Soccer", status: "INACTIVE", birthDate: new Date("2015-09-07"), gender: "FEMALE", organizationId: ORG2_ID, customId: "MSC-005" } }),
    prisma.athlete.upsert({ where: { id: `${ORG2_ID}-ath-6` }, update: {}, create: { id: `${ORG2_ID}-ath-6`, firstName: "Noah", lastName: "Irving", name: "Noah Irving", level: "Intermediate", group: "Teen Basketball", status: "ACTIVE", birthDate: new Date("2012-11-19"), gender: "MALE", organizationId: ORG2_ID, customId: "MSC-006" } }),
  ]);
