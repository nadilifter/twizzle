  ...
  const sportsData = [
    {
      ...
      name: "Athletics",
      slug: "athletics",
      description: "Track and field athletics including running, jumping, and throwing disciplines",
      displayOrder: 0,
    },
    {
      id: "sport-gymnastics",
  ...
  const announcementData = [
    {
      ...
      content: "Registration for our Annual Spring Invitational is now open!",
    ...
    },
    {
      ...
      content: "Mandatory parent meeting for all JO team families.",
    ...
    },
    {
      ...
      content: "We're organizing carpools for the upcoming swim meet.",
      targetScope: "PROGRAM" as const,
