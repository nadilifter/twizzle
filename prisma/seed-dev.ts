...
async function main() {
  ...
  await Promise.all([
    ...
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-3` }, update: {}, create: { id: `${ORG1_ID}-ath-3`, name: "Olivia Baker", level: "Competitive", group: "JO Team", status: "ACTIVE", birthDate: new Date("2013-11-08"), organizationId: ORG1_ID, customId: "SGA-003" } }),
    ...
    prisma.athlete.upsert({ where: { id: `${ORG1_ID}-ath-6` }, update: {}, create: { id: `${ORG1_ID}-ath-6`, name: "Grace Davis", level: "Competitive", group: "JO Team", status: "ACTIVE", birthDate: new Date("2011-05-20"), organizationId: ORG1_ID, customId: "SGA-006" } }),
