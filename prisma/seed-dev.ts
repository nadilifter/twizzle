...
async function main() {
  ...
  const dcPrograms = [
    prisma.program.upsert({ where: { id: "dc-prog-kcaf2026-aadlh" }, update: {}, create: {
      ...
      programType: "SINGLE_INSTANCE", pricingModel: "FLAT_RATE", basePrice: 50.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-advanced`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysFromNow(85), endDate: daysFromNow(88), capacity: 10,
    }}),
    prisma.program.upsert({ where: { id: "dc-prog-kcaf2026-aadstack" }, update: {}, create: {
      ...
      programType: "SINGLE_INSTANCE", pricingModel: "FLAT_RATE", basePrice: 50.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-intermediate`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysFromNow(85), endDate: daysFromNow(88), capacity: 12,
    }}),
    prisma.program.upsert({ where: { id: "dc-prog-kcaf2026-aapp" }, update: {}, create: {
      ...
      programType: "SINGLE_INSTANCE", pricingModel: "FLAT_RATE", basePrice: 50.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-inter-adv`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysFromNow(85), endDate: daysFromNow(88), capacity: 12,
    }}),
    prisma.program.upsert({ where: { id: "dc-prog-kcaf2026-bsbdrag" }, update: {}, create: {
      ...
      programType: "SINGLE_INSTANCE", pricingModel: "FLAT_RATE", basePrice: 40.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-intro`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysFromNow(85), endDate: daysFromNow(88), capacity: 20,
    }}),
    prisma.program.upsert({ where: { id: "dc-prog-kcaf2026-c4everyone" }, update: {}, create: {
      ...
      level: "Open", status: "ACTIVE", organizationId: ORG_DISCOVER_CIRCUS_ID,
      programType: "SINGLE_INSTANCE", pricingModel: "FLAT_RATE", basePrice: 2.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-intro`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysFromNow(85), endDate: daysFromNow(88), capacity: 20,
    }}),
    ...
    prisma.program.upsert({ where: { id: "dc-prog-osl4-jw-ss2026" }, update: {}, create: {
      ...
      level: "Inter-Adv", status: "ACTIVE", organizationId: ORG_DISCOVER_CIRCUS_ID,
      programType: "SUBSCRIPTION", pricingModel: "FLAT_RATE", basePrice: 38.0,
      levelId: `${ORG_DISCOVER_CIRCUS_ID}-level-inter-adv`, showLevelOnSite: true, showCoachOnSite: true, startDate: daysAgo(31), endDate: daysFromNow(142), capacity: 8,
    }}),
    ...
    prisma.program.upsert({ where: { id: "dc-prog-ac-bmt-ss2026" }, update: {}, create: {
      ...
      level: "Open", status: "ACTIVE", organizationId: ORG_DISCOVER_CIRCUS_ID,
      programType: "SUBSCRIPTION", pricingModel: "FLAT_RATE", basePrice: 5.0,
