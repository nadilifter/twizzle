...
const RESERVED_DOMAIN_DATA = [
  ...
  { pattern: "superadmin", type: ReservedDomainType.EXACT, reason: "System use - superadmin portal" },
  ...
  // Brand protection
  { pattern: "uplifter", type: ReservedDomainType.EXACT, reason: "Brand protection - Uplifter trademark" },
  { pattern: "leapfrog", type: ReservedDomainType.EXACT, reason: "Brand protection - LeapFrog trademark" },
  ...
  { pattern: "test-", type: ReservedDomainType.PREFIX, reason: "System use - testing environments" },
  { pattern: "demo-", type: ReservedDomainType.PREFIX, reason: "System use - demo environments" },
  { pattern: "staging-", type: ReservedDomainType.PREFIX, reason: "System use - staging environments" },
  { pattern: "dev-", type: ReservedDomainType.PREFIX, reason: "System use - development environments" },
]
...
async function main() {
  ...
  console.log(`Seeding completed. Created/updated ${RESERVED_DOMAIN_DATA.length} reserved domains.`)
}
